        ...
        $('#dtop').DataTable(
            {
                ...
                "columns":[
                    {
                        data: 'actionsEliminar',
                        "width": "5%",
                        "bSortable": false,
                        "searchable": false,
                        "targets": 0,
                        "render": function (data, type, row) {
                            return $('<div />').html(row.actionsEliminar).text();
                        }
                    },
                    {data: 'roles', "width": "50%",
                            "bSortable": false,
                            ...
                            "targets": 0,
                            "render": function (data, type, row) {
                                return $('<div />').html(row.roles.toUpperCase()).text();
                            }
                    },
                    {
                        data: 'actions',
                        ...
                        "render": function (data, type, row)
                        {
                            ...
                            $.each(codAndName, function (key, data)
                            {
                                ...
                                div += '<tr>' +
                                    ...
                                    '<td width="10%"><small class="btn btn-danger btn-xs" onclick="PedirConfirmacion(\'' + row.id + '\',\'' + tribunal[0] + '\', \'' + 'delete' + '\')" class="label label-danger" title="Eliminar "><span class="fa fa-trash"></span></small></td>' +
                                    '</tr>';
                            });
