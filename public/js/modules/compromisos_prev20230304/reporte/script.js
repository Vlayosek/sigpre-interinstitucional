...
$(function() {
    // inicia al cargar la pagina el datatables de reporte de mapa datos para mapa de calor...
    generaDataTableMapa([]);
...
function retornaUrl(tipo_detalle = false) {
    ...
    if (arregloCompromisosMapa.length == 0)
        filtro_compromiso = 0
...
function generaDataTableMapa(data) {
	...
	"lengthMenu": [
        ...
        "footerCallback": function(row, data, start, end, display) {
            ...
            $("#total_provincias").html(pageTotal_2);
            ////$("#total_compromisos").html(pageTotal_2+pageTotal);
