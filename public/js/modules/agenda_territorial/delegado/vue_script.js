    ...
    data: {
        ...
        methods: {
            ...
            async editarDelegado(id){
                var urlKeeps='editarDelegado'; //setea la ruta
                var fill={
            ...
            async eliminarDelegado(id){//eliminar un registro 
                ...
                function (isConfirm) {
                    if (isConfirm) {
                        var urlKeeps='eliminarDelegado'; //setea la ruta del controlador
            ...
            async cambiarEstadoDelegado(id, estado) {//eliminar un registro 
                let result = await swal(
                    {
                        title: "Estás seguro de realizar esta accion",
                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                            var urlKeeps = 'cambiarEstadoDelegado'; //setea la ruta del controlador
                            var fill = { 'id': id }//busca el id y lo almacena en la var 'id'
                            app.cargando = true; //mientras busca la data, el indicador se activa "cargando"
                            axios.post(urlKeeps, fill) //elimino registro
                                .then(response => {
