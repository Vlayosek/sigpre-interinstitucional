$(function () {
   ...
   $(".chat-toggle").on("click", function (e) {
       ...
       UsuarioChatGlobal=user_id;
       let username = ele.attr("data-user");
       $(".heading-name-meta").html((username.replace("."," ")));
       $(".heading-name-meta").html((username.replace("."," ")));
