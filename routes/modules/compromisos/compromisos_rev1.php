...
Route::group([
    ...
    Route::get('getDatatableSolicitudServerSide/{tipo}', [CompromisosController::class, 'getDatatableSolicitudServerSide']);
    Route::get('getDatatableCompromisosGETServerSide', [CompromisosController::class, 'getDa||tatableCompromisosGETServerSide']);    Route::get('getDatatableCompromisosServerSide/{tipo}/{tabla}/{asignaciones}/{temporales}/{pendientes}/{filtro}/{institucion_id}/{gabinete_id}', [CompromisosController::class, 'getDatatableCompromisosServerSide']);
