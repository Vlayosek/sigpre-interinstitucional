...
@section('javascript')
    ...
    <script src="{{ url('js/modules/compromisos/ministro/script.js?v=6') }}"></script>
...
@section('content')
    <div id="main">
        ...
        @include('modules.compromisos.ministro.modal_registro')
    ...
    <script src="{{ url('js/modules/compromisos/ministro/vue_script.js?v=6') }}"></script>
@endsection
