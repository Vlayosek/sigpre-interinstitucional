                                ...
                                <div class="tab-pane active" id="tab1">
                                    <div class="modal-body">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            [':disabled'=>'disabled_institucion','v-model' =>
                                            'formCrear.institucion_id', 'class' => 'select2 form-control
                                            form-control-sm', 'id' => 'filtro_institucion', 'name' =>
                                            'filtro_institucion_', 'placeholder' => 'SELECCIONE UNA OPCION']) !!}
                                        </div>
                                        <div class="col-md-12">
                                            <label>Ministros:</label>
                                            {!! Form::select('ministro_usuario_id', $usuarios_ministros, null,
                                            ['v-model' => 'formCrear.ministro_usuario_id', 'class' => 'select2
                                            form-control form-control-sm', 'id' => 'ministro_usuario_id', 'placeholder'
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12">
                    ...
                    [':disabled'=>'disabled_institucion','class' => 'select2
                    form-control form-control-sm', 'id' => 'filtro_gabinete', 'name' => 'filtro_gabinete_',
                    'placeholder' => 'SELECCIONE UNA OPCION']) !!}
                </div>
                <div class="col-md-12">
                    <label>Ministros:</label>
                    {!! Form::select('filtro_ministro_id', $usuarios_ministros, null, ['class' => 'select2 form-control form-control-sm', 'id' =>
                    'filtro_ministro_id', 'placeholder' => 'SELECCIONE UNA OPCION']) !!}
                </div>
            </div>
            <div class="modal-footer justify-content-end">
