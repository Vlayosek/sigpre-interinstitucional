...
@section('javascript')
  ...
  <script src="{{ url('js/modules/compromisos/reporte/script.js?v=7') }}" type="module"></script>
    ...
    <div class="card">
                    ...
                    <div class="col-md-10">
                        <div class="btn-group dropdown" style="float:left">
                            <button class="btn btn-default dropdown-toggle" aria-haspopup="true" aria-expanded="false"
                                onclick="transaccionToogle(this)">Filtros de Datos<span
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="#" class="dropdown-item" data-toggle="modal"
                                        data-target="#modal-MAPA_CALOR1" v-on:click="limpiarMapaCompromisoIndividual();consultasCC();"
                                        data-backdrop="static" data-keyboard="false"
                        ...
                        <button id="cmd" class="btn btn-default" v-show="habilitaImprimir"><img src="/images/icons/pdf.png" width="15px"
                                heigh="10px">&nbsp;IMPRIMIR</button>
                        <div id="elementH"></div>
                        <br />
                        <button class="btn btn-default btn-block hidden" type="button" v-on:click="exportarReporteIndividual()">
                ...
                <div class="row">
                    <div class="col-md-12 hidden"
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-2"
                                style="float:right;padding-right: 0px; padding-left: 0px;width:60%">
                                <button class="btn btn-info btn-block btn-sm" data-toggle="modal"
                                    data-target="#modal-DETALLADO"
                                    v-on:click="limpiarReporteEjecutivo();consulta_compromiso();" data-backdrop="static"
                                    data-keyboard="false"><i class="fa fa-filter"></i>&nbsp;Reporte Detallado</button>
                            </div>&nbsp;&nbsp;&nbsp;
                            <div class="col-md-2"
                                style="float:right;padding-right: 0px; padding-left: 0px;width:60%">
                                <button class="btn btn-info btn-block btn-sm" data-toggle="modal"
                        ...
                        <div class="row justify-content-center align-items-center">
                            ...
                            <div class="col-md-2"
                                ...
                                <button class="btn btn-info btn-block btn-sm" data-toggle="modal"
                                    data-target="#modal-MAPA_CALOR2" v-on:click="limpiarMapaTodosCompromisos()"
                                    data-backdrop="static" data-keyboard="false"><i class="fa fa-filter"></i>Todos los
                                    Compromisos</button>
                            </div>
                        </div>
                    </div>
        ...
        <div id="page-pdf">
            <div class="card-body" id="contentReporteIndividual" style="background-color: #ffffff">
                <button id="BotonDatatable" onclick="datatableCompromisosCumplidosRep()"
                    class="hidden"></button>
                <div class="row">
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-sm-2">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-info" style="min-height: 60px;">
                                            <div class="card-header">
                                                <h3 class="card-title">Cantones</h3>
                                            </div>
                                ...
                                <div class="card card-info" style="min-height: 665px;" id="tablaUbicacion">
                                    ...
                                    <div class="card-body">
                                        <div class=" table table-responsive" id="tablaConsulta">
                                            ...
                                            <table class="table mapa table-bordered table-striped" id="dtmapa"
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class=" table table-responsive" id="tablaConsulta">
                                            ...
                                            <div id="heatmap" style="width: 100%; height: 600px; position: relative;">
                                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        <div class=" table table-responsive" id="grafico_estado"
        ...
        @include('modules.compromisos.reporte.modal_reporte')
    </div>
</div>
<script src="{{ url('js/vue.js') }}"></script>
<script src="{{ url('js/axios.js') }}"></script>
<script src="{{ url('js/modules/compromisos/reporte/vue_script.js?v=4') }}"></script>
