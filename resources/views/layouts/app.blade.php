...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="content">
                        ...
                        <div class="">
                            ...
                            @if (config('app.NOTIFICACIONES') != 'COMPROMISO')
                                <div id="main2">
                                    @auth
                                        @include('modules.talento_humano.distributivo.modal_persona', [
                                            'rolConsultaUATH_' => Auth::user()->evaluarole(['CONSULTA DE UATH']),
                                        ])
                                    @endauth
                                </div>
                                ...
                                @yield('vue_js')
                                <script src="{{ url('js/modules/talento_humano/personas/sigpre/vue_funcionarios.js?v=30') }}"></script>
                            @else
                                <script src="{{ url('js/vue.js') }}"></script>
                                <script src="{{ url('js/axios.js') }}"></script>
                            @endif
            ...
            @if (config('app.NOTIFICACIONES') != 'COMPROMISO')
                <script src="{{ url('js/modules/notificaciones/vue_script.js?v=2') }}"></script>
            @else
                <script src="{{ url('js/modules/notificaciones/compromisos_vue_script.js?v=2') }}"></script>
            @endif
            <script src="{{ url('js/modules/notificaciones/script.js?v=2') }}"></script>
