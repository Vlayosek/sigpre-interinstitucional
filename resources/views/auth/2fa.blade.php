                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('login.2fa', $user->id) }}" aria-label="{{ __('Login') }}">
                            ...
                            <div class="form-group row">
                                @if (!is_null($generado))
                                    <div class="col-lg-4">
                                        <img id="imgQR" width="200px" src="{{ $urlQR }}" />
                                        <br/>
                                        <span style="font-size:16px">{{$token }}</span>
                                    </div>
                                    <div class="col-lg-8">
                                    @else
                                        <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="code_verification" type="text"
                                        class="form-control{{ $errors->has('code_verification') ? ' is-invalid' : '' }}"
                                        name="code_verification" value="{{ old('code_verification') }}" required
                                        autofocus>
